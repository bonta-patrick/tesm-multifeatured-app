    ...
    <div class="md:hidden">
        <section id="home-page" class="flex flex-col bg-black min-h-screen overflow-auto">
            ...
            <div class="flex flex-col items-center justify-center flex-1 h-full w-full bg-slate-800">
                ...
                <h1 class="py-6 px-4 font-bold text-white text-4xl text-center">Enhancing Chat</h1>
                <p class="py-2 px-4 text-center text-lg text-slate-500 max-w-4xl">
                    Search and join a channel or create one yourself! You can then invite users to your channel and have fun!
                </p>
                <div class="flex flex-row items-center justify-center py-6 px-4 ml-4 mr-4 my-8 bg-gradient-to-r from-blue-400 to-blue-700 rounded rounded-md">
                    <button type="button" data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="bg-transparent text-white font-mono font-bold">Search Channel</button>
                </div>
              </div>
            ...
            <div class="bg-black rounded rounded-lg h-[100vh] p-10">
                ...
                <div class="flex flex-col mt-32 space-y-12">
                    ...
                    <a href="./profile.html" class="flex flex-row space-x-4 items-center justify-center">
                        <img src="./images/pr-2.jpg" alt="" class="rounded rounded-lg" height="30px" width="30px">
           ...
           <div class="flex flex-row items-start justify-start overflow-auto w-full h-[100vh] border-l-2 border-white">
            <div class="flex flex-col px-8 lg:px-8 py-8 bg-slate-950 w-1/3 lg:w-1/4 h-full border-r-2 border-white">
                ...
                <!--<div class="flex flex-col space-y-4">
                    <div class="flex flex-row items-center justify-start space-x-6 bg-slate-900 p-4 rounded rounded-lg">
                        <img src="./images/pr-2.jpg" alt="" height="65px" width="65px" class="rounded rounded-lg">
                        <div class="flex flex-col space-y-1 hidden 2xl:block">
                            <h1 class="text-white text-xl font-bold">theboys</h1>
                            <p class="text-slate-600 text-lg">#3thb21g</p>
                        </div>
                    </div>
                    <div class="flex flex-row space-x-6 bg-slate-900 p-4 rounded rounded-lg">
                        <img src="./images/pr-2.jpg" alt="" height="65px" width="65px" class="rounded rounded-lg">
                    </div>
                </div>-->
                <p class="text-lg text-slate-500 font-bold mt-2">No channels</p>
            </div>
                ...
                <div class="flex flex-col p-6 overflow-auto" id="message-container">
                    ...
                    <div class="flex flex-col p-6 rounded rounded-lg space-y-4 ml-2 hover:bg-slate-900">
                        <div class="flex flex-row items-center justify-start space-x-2 max-w-2xl">
                           <img src="./images/pr-2.jpg" alt="" height="55px" width="55px" class="rounded rounded-lg">
            ...
            -->
              <div class="flex flex-col items-center justify-center flex-1 h-full w-full bg-slate-800">
                <i class="bi bi-chat-left-dots-fill text-transparent text-8xl bg-clip-text bg-gradient-to-r from-blue-400 to-green-600"></i>
                <h1 class="py-6 px-4 font-bold text-white text-8xl text-center">Enhancing Chat</h1>
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-slate-800 rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-col p-6 space-y-6 h-[50vh] overflow-auto">
                            ...
                            <div class="flex flex-row items-center justify-start space-x-6 bg-slate-900 p-4 rounded rounded-lg cursor-pointer" onclick="location.href='/channels/channel/{{$channel->id}}'">
                                <img src="/storage/channels/{{$channel->channel_image}}" alt="" style="width: 65px; height: 65px;" class="rounded rounded-lg">
                                <div class="flex flex-col space-y-1">
                                    <h1 class="text-white text-xl font-bold">{{$channel->channel_name}}</h1>
                                    <p class="text-slate-600 text-lg">#3thb21g</p>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="relative bg-slate-800 rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-col h-[60vh] overflow-auto p-6 space-y-6">
                        <div class="flex flex-row items-center justify-start bg-gradient-to-r from-blue-400 to-blue-600 text-white p-6 rounded rounded-lg space-x-4">
                            <img src="./images/pr-2.jpg" alt="" height="75px" width="75px" class="rounded rounded-lg">
                    ...
                    <div class="flex flex-col p-6 space-y-6 h-[60vh] overflow-auto">
                        <div class="hidden flex flex-row p-10 items-start justify-start space-x-5" id="commentBox">
                            <div class="flex flex-row items-center">
                                <img src="./images/pr-2.jpg" alt="" class="rounded rounded-lg" height="65px" width="65px">
                        ...
                        <div class="flex flex-col w-full space-y-4 mt-4 h-[40vh] overflow-auto bg-slate-900 rounded rounded-lg p-4">
                            ...
                            <div class="flex flex-row items-center justify-between p-4 bg-slate-700 rounded rounded-lg space-x-4">
                                <div class="flex flex-row space-x-4 items-center justify-start">
                                    <img src="/storage/channels/{{$channel->channel_image}}" alt="" height="55px" width="55px" class="rounded rounded-lg">
