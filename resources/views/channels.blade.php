...
<body>
       ...
       <section id="home-page" class="flex flex-col bg-black min-h-screen overflow-auto">
            ...
            <div class="flex flex-col">
                <div class="flex flex-row mb-6 border-b border-white">
                    <div class="flex flex-row space-x-4 items-center justify-center">
                      <img src="./images/pr-image.jpg" alt="" class="rounded rounded-lg mb-5" height="45px" width="45px">
                      <h1 class="text-white font-medium text-xl -mt-4">Hans</h1>
                    </div>
                </div>
                <img src="./images/coast.jpg" alt="" class="rounded rounded-md">
                <p class="py-6 text-white">Look at this awesome view! I enjoyed the view very much!</p>
        ...
        <div class="flex flex-col py-6 px-4 w-{130px} ml-4 mr-4 my-4 bg-slate-900 rounded rounded-md">
            <div class="flex flex-col">
                <div class="flex flex-row mb-6 border-b border-white">
                    <div class="flex flex-row space-x-4 items-center justify-center">
                      <img src="./images/pr-image.jpg" alt="" class="rounded rounded-lg mb-5" height="45px" width="45px">
                      <h1 class="text-white font-medium text-xl -mt-4">jack_mars</h1>
                    </div>
                </div>
                <img src="./images/coast.jpg" alt="" class="rounded rounded-md">
                <p class="py-6 text-white">Look at this awesome view! I enjoyed the view very much!</p>
        ...
        <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
            <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                ...
                <button type="submit" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" onclick="location.href='./uploadpost.html'">
                ...
                <button type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group" onclick="location.href='./profile.html'">
    ...
    <div class="hidden md:block">
        <section id="home" class="flex flex-row items-start justify-between bg-black min-h-screen">
           ...
           <div class="flex flex-col items-center justify-center overflow-auto w-full h-[100vh] border-l-2 border-white">
            ...
            <p class="py-2 px-4 text-center text-2xl text-slate-500 max-w-4xl">Channels bring people with the same interests together. Join any topic and 
            ...
            <div class="flex flex-row items-center justify-center py-6 px-4 ml-4 mr-4 my-8 bg-gradient-to-r from-blue-400 to-blue-700 rounded rounded-md">
                <button type="button" data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="bg-transparent text-white font-mono font-bold">Go to channels</button>
            </div>
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <div class="relative bg-slate-800 rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-col p-6 space-y-6">
                        ...
                        <textarea name="" id="" cols="30" rows="2" class="bg-slate-900 text-white py-4 px-4 mx-4 my-4 rounded rounded-lg" placeholder="Write captions"></textarea>
                    </div>
                    <!-- Modal footer -->
